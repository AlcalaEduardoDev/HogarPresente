...
export class NavbarComponent implements OnInit {
  ...
  constructor(private userAlumnoService:UserAlumnoService, private route:Router, private nuevoAlumno:Alumno, public alumnoLogeado:Alumno) { }
  ...
  public verificacion(){
   ...
   Registrar(){
     this.nuevoAlumno.icon=this.icono;
     this.nuevoAlumno.email=this.user;
     this.nuevoAlumno.nombre=this.nombreReg;
     this.nuevoAlumno.apellido=this.apellidoReg;
     this.nuevoAlumno.pass=this.password;
